...
from app.utils.models import TimestampedModelMixin
from django.db import models
from django.utils import timezone

from app.projects.models import Project
from app.users.models import User
from app.utils.models import CreatedByModelMixin

from .types import APIRole, APIAccessLifespan
...
class ProjectAPIAccess(CreatedByModelMixin, TimestampedModelMixin, models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.id is None and self.expires_at is None:
            self.expires_at = timezone.now() + datetime.timedelta(days=self.lifespan_days)
